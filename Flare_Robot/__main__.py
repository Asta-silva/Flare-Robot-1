...
GROUP_START_IMG = "https://telegra.ph/file/1246fc837e2dbcff3d6c5.mp4"

FLARE_PHOTO = "https://telegra.ph/file/2d06d511598cb496e08cd.jpg"
...
• *Uptime:* `{}`
➖➖➖➖➖➖➖➖➖➖➖
➛ Try The Help Buttons Below To Know My Abilities[.](https://telegra.ph/file/6a37c0df37954ff0407b5.jpg) ××
"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_animation(
            GROUP_START_IMG, caption= "ʜᴇʏ! ᴄᴜᴛᴇ ʀᴇᴍ ɪs ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ!!!\n<b>Haven't slept since:</b> <code>{}</code>".format(
                uptime
            ),
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="Help",
                                url="t.me/itz_rem_robot?start=ghelp_{}".format(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Help",
                            url="t.me/itz_rem_robot?start=help".format(context.bot.username),
                        ),
                    ],
                ],
            ),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 2105723446 and DONATION_LINK:
            update.effective_message.reply_text(
